...
<header class="p-3 mb-0 border-bottom bg-white">
    <div class="container-fluid py-3">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="/CRUD-ALOJAMIENTOS/index_user.php" class="d-flex align-items-center mb-2 mb-lg-0 link-body-emphasis text-decoration-none">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0 px-4">
                <li><a href="/CRUD-ALOJAMIENTOS/index_user.php" class="nav-link px-2 link-body-emphasis">Inicio</a></li>
                <?php
